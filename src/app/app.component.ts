...
import { JobAppliedFor } from './Model/jobappliedfor';
...
export class AppComponent {
  ...
  createpdf(){
    ...
    //Job Applied For
    let jobApplied:JobAppliedFor = new JobAppliedFor(this.resume.jobAppliedFor);
    ...
    let resume=new Resume(head, jobApplied,edlist,explist,map, prolist);
    console.log(resume);
